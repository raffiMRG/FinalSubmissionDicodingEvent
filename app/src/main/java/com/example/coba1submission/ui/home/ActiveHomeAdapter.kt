...
class ActiveHomeAdapter : ListAdapter<ListEventsItem, ActiveHomeAdapter.MyViewHolder>(DIFF_CALLBACK) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ActiveHomeItemRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MyViewHolder(val binding: ActiveHomeItemRowBinding) : RecyclerView.ViewHolder(binding.root) {
